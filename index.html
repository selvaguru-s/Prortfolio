                    ...
                    <nav class="navbar navbar-expand-lg mh-nav nav-btn">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#mh-cert">Certifications</a>
                                </li>                                  
                                <li class="nav-item">
                    ...
                    <div class="row xs-column-reverse section-separator vertical-middle-content home-padding">
                        <div class="col-sm-6">
                            <div class="mh-header-info">
                                ...
                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Selvaguru</h2>
                                <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">CyberSecurity Researcher</h4>
                                
                                <ul>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fa fa-envelope"></i><a href="mailto:">selvaguru2017@gmail.com</a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s"><i class="fa fa-phone"></i><a href="callto:">+91 9600703266</a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i><address>Tamil Nadu, India</address></li>
				     <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i><address>London, UK (currently)</address></li>
                                </ul>
                        ...
                        <div class="col-sm-6">
                            <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <div class="img-border">
                                    <img src="selva-img.jpg" alt=""  class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row section-separator">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="mh-about-inner">
                            ...
                            <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">I am passionate in cyber security and ethical Hacking. I have knowledge in Linux OS(Kali Linux) and Tools like
Nmap, Buprsuite, OWASP-ZAP, NESSUS, Metasploit, etc. And I also have a knowledge in programming and
scripting.</p>
                            <div class="mh-about-tag wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                <ul>
                                    <li><span>Nmap</span></li>
                                    <li><span>Burp suite</span></li>
                                    <li><span>Metasploit</span></li>
                                    <li><span>Nessus</span></li>
                                    <li><span>Sqlmap</span></li>
                                    <li><span>Wireshark</span></li>
                                  
                                </ul>
                            </div>
                            <a href="RESUME.pdf" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">Downlaod CV <i class="fa fa-download"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row section-separator">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                            ...
                            <p>
                         Web development is the work involved in developing a Web site for the Internet or an intranet.Web development can range from developing a simple single static page of plain text to complex web applications, electronic businesses, and social network services.            </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
        ...
        <section class="mh-skills" id="mh-skills">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="mh-skills-inner">
                            <div class="mh-professional-skill wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                <h3>Technical Skills - (Security Tools and programming)</h3>
                                <div class="each-skills">
                                    <div class="candidatos">
                                        <div class="parcial">
                                            <div class="info">
                                                <div class="nome">Nmap</div>
           ...
           <div class="candidatos">
                                        <div class="parcial">
                                            <div class="info">
                                                <div class="nome">Bootstarp and Wordpress</div>
                            ...
                            <div class="mh-education">
                                ...
                                <div class="mh-education-deatils">
                                    ...
                                    <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                        <h4>Bachelor of Engineering <a href="#">K. Ramakrishnan college of engineering</a></h4>
                                        <div class="mh-eduyear">2017 - 2021</div>
                                        <p>Computer science and engineering, 79%</p>
                                    </div>                                
                                    <!-- Education Institutes-->
                                    <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                                        <h4>12th Grade <a href="#">St. Andrews matriculation higher secondary school</a></h4>
                                        <div class="mh-eduyear">2016 - 2017</div>
                                        <p>Computer science, 83% </p>
                                    </div>                                
                                    <!-- Education Institutes-->
                                    <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                        <h4>10th Grade <a href="#">St. Andrews matriculation higher secondary school</a></h4>
                                        <div class="mh-eduyear">2014 - 2015</div>
                                        <p> 93%</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mh-work">
                                ...
                                <div class="mh-experience-deatils">
                                    ...
                                    <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                        <h4>Junior penetration Tester <a href="#"> SentryArk</a></h4>
                                        <div class="mh-eduyear">6 month of Intership</div>
                                        <span>Responsibility :</span>
                                        <ul class="work-responsibility">
                                            <li><i class="fa fa-circle"></i>web Pentest</li>
                                            <li><i class="fa fa-circle"></i>Report Writing</li>
                                        </ul>
                                    </div>                                
        ...
        ===================
        -->
        <section class="mh-portfolio" id="mh-cert">
            <div class="container">
                <div class="row section-separator">
                    ...
                    <div class="part col-sm-12">
                        <div class="portfolio-nav col-sm-12" id="filter-button">
                            <ul>
                                <li data-filter="*" class="" data-wow-duration="0.8s" data-wow-delay="0.1s"> <span>certificates</span></li>
                                ...
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            ...
                                            <h5 class="title">ICSI</h5>
                                            <span class="sub-title">CNSS</span>
                                            <a data-fancybox data-src="images/1.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        <img src="images/2.png" alt="img04">
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">NSE</h5>
                                            <span class="sub-title">LEVEL 1</span>
                                            <a data-fancybox data-src="images/2.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 ">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">ANZ</h5>
                                            <span class="sub-title">Intership</span>
                                            <a data-fancybox data-src="images/3.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 ">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            ...
                                            <a data-fancybox data-src="images/4.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            ...
                                            <a  data-fancybox data-src="images/5.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 ">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">GOOGLE</h5>
                                            <span class="sub-title">Google Analytics</span>
                                            <a  data-fancybox data-src="images/6.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">Google</h5>
                                            <span class="sub-title">Google cloud Business</span>
                                            <a  data-fancybox data-src="images/7.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">CISCO</h5>
                                            <span class="sub-title">Introduction to Cybersecurity</span>
                                            <a data-fancybox data-src="images/8.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 ">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            ...
                                            <a data-fancybox data-src="images/10.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
               <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            ...
                                            <span class="sub-title">Cybersecurity course</span>
                                            <a data-fancybox data-src="images/15.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
               <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">Skill Rack</h5>
                                            <span class="sub-title">C programming</span>
                                            <a data-fancybox data-src="images/16.jpg"></a>
                                        </figcaption>
                                    </figure>
                                </div>
               <div class="grid-item col-md-4 col-sm-6 col-xs-12">
                                    <figure>
                                        ...
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                            <h5 class="title">ARIFA</h5>
                                            <span class="sub-title">International E-conference</span>
                                            <a data-fancybox data-src="images/17.png"></a>
                                        </figcaption>
                                    </figure>
                                </div>
        ...
        ===================
        -->
        <section class="mh-blog" id="mh-portfolio">
            <div class="container">
                <div class="row section-separator">
                    ...
                    <div class="col-sm-12 col-md-4">
                         <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            ...
                            <div class="blog-inner">
                                <h2><a href="https://hitechpackers.in/">website for Packers and Movers</a></h2>
                                <div class="mh-blog-post-info">
                                    <ul>
                                    <li><strong>Vist</strong><a href="https://hitechpackers.in/">hitechpackers.in</a></li>
                                    </ul>
                                </div>
                                <p>Static website developed using Bootstarp v5.</p>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                            <img src="images/movers.jpg" alt="" class="img-fluid">
                            <div class="blog-inner">
                                <h2><a href="">E-commerce site</a></h2>
                                <div class="mh-blog-post-info">
                                    <ul>
                                      
                                        <li><strong>Vist</strong><a href="http://dhruvatraders.in/">dhruvatraders.in</a></li>
                                    </ul>
                                </div>
                                <p>E-commerce website using wordpress.</p>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                        ...
                                        <div class="each-info">
                                            <h4>Address</h4>
                                            <address>
                                                perambalur(DT),Tamil Nadu, India.
                                            </address>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                                        ...
                                        <div class="each-info">
                                            <h4>Email</h4>
                                            <a href="mailto:selvaguru2017@gmail.com">selvaguru2017@gmail.com</a><br>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                        ...
                                        <div class="each-info">
                                            <h4>Phone</h4>
                                            <a href="callto:+919600703266">+91 9600703266</a><br>
...
<a href="https://wa.me/919600703266" class="float" target="_blank">
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<a href="mailto:selvaguru2017@gmail.com?subject=Hai mate" class="float2" target="_blank">
<i class="fa fa-google wp-button2"></i>
</a>
